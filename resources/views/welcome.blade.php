    ...
    <body class="antialiased">
        ...
        >
            ...
            <div class="p-6 mx-auto max-w-7xl lg:p-8">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                        ...
                        >
                            <div>
                                <div
                                    class="flex items-center justify-center w-16 h-16 rounded-full bg-red-50"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                ...
                <div
                    class="flex justify-center px-0 mt-16 sm:items-center sm:justify-between"
                >
                    <div class="text-sm text-center sm:text-left">&nbsp;</div>

                    <div
                        class="text-sm text-center text-gray-500 sm:text-right sm:ml-0"
                    >
