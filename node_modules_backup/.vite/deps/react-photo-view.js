...
function m(e2, n2) {
  ...
  for (r2 = 0; r2 < o2.length; r2++) n2.indexOf(t2 = o2[r2]) >= 0 || (i2[t2] = e2[t2]);
  return i2;
}
function g(e2) {
...
var y = "undefined" != typeof window && "ontouchstart" in window;
var x = function(e2, n2, t2) {
  return Math.max(Math.min(e2, t2), n2);
};
var C = function(e2, n2, t2) {
  return void 0 === n2 && (n2 = 0), void 0 === t2 && (t2 = 0), x(e2, 1 * (1 - t2), Math.max(6, n2) * (1 + t2));
};
var b = "undefined" == typeof window || /ServerSideRendering/.test(navigator && navigator.userAgent) ? import_react.useEffect : import_react.useLayoutEffect;
function E(e2, t2, r2) {
...
var k = ["container"];
function P(n2) {
  var t2 = n2.container, r2 = void 0 === t2 ? document.body : t2, i2 = m(n2, k);
...
function V(e2, n2, t2) {
  var r2 = T(t2, innerWidth, innerHeight), i2 = r2[0], o2 = r2[1], a2 = 0, c2 = i2, u2 = o2, l2 = e2 / n2 * o2, s2 = n2 / e2 * i2;
...
var A = function(e2, n2, t2) {
  return H(e2, n2, t2, 100, function(e3) {
    return e3;
  }, function() {
    return H(n2, e2, t2);
  });
...
function H(e2, n2, t2, r2, i2, o2) {
  void 0 === r2 && (r2 = 400), void 0 === i2 && (i2 = I);
  var a2 = n2 - e2;
  if (0 !== a2) {
...
var L = { T: 0, L: 0, W: 0, H: 0, FIT: void 0 };
var F = function() {
...
var D = ["className"];
function O(n2) {
  var t2 = n2.className, r2 = void 0 === t2 ? "" : t2, i2 = m(n2, D);
...
var B = ["src", "loaded", "broken", "className", "onPhotoLoad", "loadingElement", "brokenElement"];
function z(n2) {
  var t2 = n2.src, r2 = n2.loaded, i2 = n2.broken, o2 = n2.className, a2 = n2.onPhotoLoad, c2 = n2.loadingElement, u2 = n2.brokenElement, l2 = m(n2, B), s2 = F();
  ...
  }, alt: "" }, l2)), !r2 && (import_react.default.createElement("span", { className: "PhotoView__icon" }, c2) || import_react.default.createElement(O, { className: "PhotoView__icon" }))) : u2 ? import_react.default.createElement("span", { className: "PhotoView__icon" }, "function" == typeof u2 ? u2({ src: t2 }) : u2) : null;
}
var j = { naturalWidth: void 0, naturalHeight: void 0, width: void 0, height: void 0, loaded: void 0, broken: false, x: 0, y: 0, touched: false, maskTouched: false, rotate: 0, scale: 1, CX: 0, CY: 0, lastX: 0, lastY: 0, lastCX: 0, lastCY: 0, lastScale: 1, touchTime: 0, touchLength: 0, pause: true, stopRaf: true, reach: void 0 };
function q(t2) {
  var r2 = t2.item, o2 = r2.src, a2 = r2.render, c2 = r2.width, l2 = void 0 === c2 ? 0 : c2, s2 = r2.height, d2 = void 0 === s2 ? 0 : s2, v2 = r2.originRef, f2 = t2.visible, m2 = t2.speed, w2 = t2.easing, x2 = t2.wrapClassName, k2 = t2.className, P2 = t2.style, _2 = t2.loadingElement, M2 = t2.brokenElement, Y2 = t2.onPhotoTap, X2 = t2.onMaskTap, I2 = t2.onReachMove, D2 = t2.onReachUp, O2 = t2.onPhotoResize, B2 = t2.isActive, q2 = t2.expose, K2 = p(j), U2 = K2[0], G2 = K2[1], J2 = (0, import_react.useRef)(0), Q2 = F(), Z2 = U2.naturalWidth, $ = void 0 === Z2 ? l2 : Z2, ee = U2.naturalHeight, ne = void 0 === ee ? d2 : ee, te = U2.width, re = void 0 === te ? l2 : te, ie = U2.height, oe = void 0 === ie ? d2 : ie, ae = U2.loaded, ce = void 0 === ae ? !o2 : ae, ue = U2.broken, le = U2.x, se = U2.y, de = U2.touched, ve = U2.stopRaf, fe = U2.maskTouched, he = U2.rotate, me = U2.scale, ge = U2.CX, pe = U2.CY, we = U2.lastX, ye = U2.lastY, xe = U2.lastCX, Ce = U2.lastCY, be = U2.lastScale, Ee = U2.touchTime, ke = U2.touchLength, Pe = U2.pause, _e = U2.reach, Me = g({ onScale: function(e2) {
    return Ye(C(e2));
  }, onRotate: function(e2) {
    he !== e2 && (q2({ rotate: e2 }), G2(h({ rotate: e2 }, V($, ne, e2))));
  } });
  function Ye(e2, n2, t3) {
    me !== e2 && (q2({ scale: e2 }), G2(h({ scale: e2 }, S(le, se, re, oe, me, e2, n2, t3), e2 <= 1 && { x: 0, y: 0 })));
  }
  var Xe = R(function(e2, n2, t3) {
    if (void 0 === t3 && (t3 = 0), (de || fe) && B2) {
      var r3 = T(he, re, oe), i2 = r3[0], o3 = r3[1];
      ...
      if (0 === t3) {
        var d3 = W(l3 + we, me, i2, innerWidth)[0], v3 = W(s3 + ye, me, o3, innerHeight);
        u2 = function(e3, n3, t4, r4) {
          return n3 && 1 === e3 || "x" === r4 ? "x" : t4 && e3 > 1 || "y" === r4 ? "y" : void 0;
        }(J2.current, d3, v3[0], _e), void 0 !== u2 && I2(u2, e2, n2, me);
      }
      if ("x" === u2 || fe) return void G2({ reach: "x" });
      var f3 = C(me + (t3 - ke) / 100 / 2 * me, $ / re, 0.2);
      q2({ scale: f3 }), G2(h({ touchLength: t3, reach: u2, scale: f3 }, S(le, se, re, oe, me, f3, e2, n2, l3, s3)));
    }
  }, { maxWait: 8 });
  function Ne(e2) {
  ...
  var We, Se, Te, Ve, Re, Ae, Ie, He, Le = (Re = function(e2) {
    ...
    var d3 = T(l3, i2, o3), v3 = d3[0], f3 = d3[1], h2 = W(e2, c3, v3, innerWidth), m3 = h2[0], g2 = h2[1], p2 = W(n2, c3, f3, innerHeight), w3 = p2[0], y2 = p2[1], x3 = Date.now() - s3;
    if (x3 >= 200 || c3 !== a3 || Math.abs(u2 - a3) > 1) {
      var C2 = S(e2, n2, i2, o3, a3, c3), b2 = C2.x, E2 = C2.y, k3 = m3 ? g2 : b2 !== e2 ? b2 : null, P3 = w3 ? y2 : E2 !== n2 ? E2 : null;
      return null !== k3 && H(e2, k3, He.X), null !== P3 && H(n2, P3, He.Y), void (c3 !== a3 && H(a3, c3, He.S));
    }
    var _3 = (e2 - t3) / x3, M3 = (n2 - r3) / x3, Y3 = Math.sqrt(Math.pow(_3, 2) + Math.pow(M3, 2)), X3 = false, N2 = false;
    !function(e3, n3) {
      ...
      var r4 = e2 + t4 * (_3 / Y3), i3 = n2 + t4 * (M3 / Y3), o4 = W(r4, a3, v3, innerWidth), c4 = o4[0], u3 = o4[1], l4 = W(i3, a3, f3, innerHeight), s4 = l4[0], d4 = l4[1];
      if (c4 && !X3 && (X3 = true, m3 ? H(r4, u3, He.X) : A(u3, r4 + (r4 - u3), He.X)), s4 && !N2 && (N2 = true, w3 ? H(i3, d4, He.Y) : A(d4, i3 + (i3 - d4), He.Y)), X3 && N2) return false;
      var h3 = X3 || He.X(u3), g3 = N2 || He.Y(d4);
      return h3 && g3;
    });
  }), Fe = (We = Y2, Se = function(e2, n2) {
    _e || Ye(1 !== me ? 1 : Math.max(2, $ / re), e2, n2);
  }, Te = (0, import_react.useRef)(0), Ve = R(function() {
  ...
  E(y ? void 0 : "mousemove", function(e2) {
    e2.preventDefault(), Xe(e2.clientX, e2.clientY);
  }), E(y ? void 0 : "mouseup", function(e2) {
    De(e2.clientX, e2.clientY);
  }), E(y ? "touchmove" : void 0, function(e2) {
    e2.preventDefault();
    var n2 = N(e2);
    Xe.apply(void 0, n2);
  }, { passive: false }), E(y ? "touchend" : void 0, function(e2) {
    var n2 = e2.changedTouches[0];
    De(n2.clientX, n2.clientY);
  }, { passive: false }), E("resize", R(function() {
    ce && !de && (G2(V($, ne, he)), O2());
  }, { maxWait: 8 })), b(function() {
    B2 && q2(h({ scale: me, rotate: he }, Me));
  }, [B2]);
  var ze = function(e2, t3, r3, o3, a3, c3, l3, s3, d3, v3) {
    var f3 = function(e3, t4, r4, i2, o4) {
      var a4 = (0, import_react.useRef)(false), c4 = p({ lead: true, scale: r4 }), u2 = c4[0], l4 = u2.lead, s4 = u2.scale, d4 = c4[1], v4 = R(function(e4) {
        try {
    ...
    }(c3, l3, s3, d3, v3), h2 = f3[0], m3 = f3[1], w3 = f3[2], y2 = function(e3, t4, r4, o4, a4) {
      var c4 = (0, import_react.useState)(L), l4 = c4[0], s4 = c4[1], d4 = (0, import_react.useState)(0), v4 = d4[0], f4 = d4[1], h3 = (0, import_react.useRef)(), m4 = g({ OK: function() {
        return e3 && f4(4);
      } });
      function p2(e4) {
        a4(false), f4(e4);
    ...
    }(e2, t3, r3, d3, v3), x3 = y2[0], C2 = y2[1], E2 = C2.W, k3 = C2.FIT, P3 = innerWidth / 2, _3 = innerHeight / 2, M3 = x3 < 3 || x3 > 4;
    return [M3 ? E2 ? C2.L : P3 : o3 + (P3 - c3 * s3 / 2), M3 ? E2 ? C2.T : _3 : a3 + (_3 - l3 * s3 / 2), h2, M3 && k3 ? h2 * (C2.H / E2) : m3, 0 === x3 ? w3 : M3 ? E2 / (c3 * s3) || 0.01 : w3, M3 ? k3 ? 1 : 0 : 1, x3, k3];
  }(f2, v2, ce, le, se, re, oe, me, m2, function(e2) {
    return G2({ pause: e2 });
  }), je = ze[4], qe = ze[6], Ke = "transform " + m2 + "ms " + w2, Ue = { className: k2, onMouseDown: y ? void 0 : function(e2) {
    e2.stopPropagation(), 0 === e2.button && Oe(e2.clientX, e2.clientY, 0);
  }, onTouchStart: y ? function(e2) {
    e2.stopPropagation(), Oe.apply(void 0, N(e2));
  } : void 0, onWheel: function(e2) {
    if (!_e) {
      var n2 = C(me - e2.deltaY / 100 / 2, $ / re);
  ...
  return import_react.default.createElement("div", { className: "PhotoView__PhotoWrap" + (x2 ? " " + x2 : ""), style: P2, onMouseDown: !y && B2 ? Be : void 0, onTouchStart: y && B2 ? function(e2) {
    return Be(e2.touches[0]);
  } : void 0 }, import_react.default.createElement("div", { className: "PhotoView__PhotoBox", style: { transform: "matrix(" + je + ", 0, 0, " + je + ", " + ze[0] + ", " + ze[1] + ")", transition: de || Pe ? void 0 : Ke, willChange: B2 ? "transform" : void 0 } }, o2 ? import_react.default.createElement(z, h({ src: o2, loaded: ce, broken: ue }, Ue, { onPhotoLoad: function(e2) {
    G2(h({}, e2, e2.loaded && V(e2.naturalWidth || 0, e2.naturalHeight || 0, he)));
  }, loadingElement: _2, brokenElement: M2 })) : a2 && a2({ attrs: Ue, scale: je, rotate: he })));
}
var K = { x: 0, touched: false, pause: false, lastCX: void 0, lastCY: void 0, bg: void 0, lastBg: void 0, overlay: true, minimal: true, scale: 1, rotate: 0 };
function U(r2) {
  var i2 = r2.loop, o2 = void 0 === i2 ? 3 : i2, c2 = r2.speed, l2 = r2.easing, s2 = r2.photoClosable, d2 = r2.maskClosable, v2 = void 0 === d2 || d2, f2 = r2.maskOpacity, h2 = void 0 === f2 ? 1 : f2, m2 = r2.pullClosable, w2 = void 0 === m2 || m2, C2 = r2.bannerVisible, k2 = void 0 === C2 || C2, N2 = r2.overlayRender, W2 = r2.toolbarRender, S2 = r2.className, T2 = r2.maskClassName, V2 = r2.photoClassName, R2 = r2.photoWrapClassName, A2 = r2.loadingElement, I2 = r2.brokenElement, H2 = r2.images, L2 = r2.index, F2 = void 0 === L2 ? 0 : L2, D2 = r2.onIndexChange, O2 = r2.visible, B2 = r2.onClose, z2 = r2.afterClose, j2 = r2.portalContainer, U2 = p(K), G2 = U2[0], J2 = U2[1], Q2 = (0, import_react.useState)(0), Z2 = Q2[0], $ = Q2[1], ee = G2.x, ne = G2.touched, te = G2.pause, re = G2.lastCX, ie = G2.lastCY, oe = G2.bg, ae = void 0 === oe ? h2 : oe, ce = G2.lastBg, ue = G2.overlay, le = G2.minimal, se = G2.scale, de = G2.rotate, ve = G2.onScale, fe = G2.onRotate, he = r2.hasOwnProperty("index"), me = he ? F2 : Z2, ge = he ? D2 : $, pe = (0, import_react.useRef)(me), we = H2.length, ye = H2[me], xe = "boolean" == typeof o2 ? o2 : we > o2, Ce = function(e2, r3) {
  ...
  b(function() {
    if (be) return J2({ pause: true, x: me * -(innerWidth + 20) }), void (pe.current = me);
    J2(K);
  }, [be]);
  var Pe = g({ close: function(e2) {
    fe && fe(0), J2({ overlay: true, lastBg: ae }), B2(e2);
  }, changeIndex: function(e2, n2) {
    void 0 === n2 && (n2 = false);
    var t2 = xe ? pe.current + (e2 - me) : e2, r3 = we - 1, i3 = x(t2, 0, r3), o3 = xe ? t2 : i3, a2 = innerWidth + 20;
  ...
  function Ne(e2, n2, t2, r3) {
    "x" === e2 ? function(e3) {
      ...
      } else J2({ touched: true, lastCX: e3, x: ee, pause: false });
    }(n2) : "y" === e2 && function(e3, n3) {
      if (void 0 !== ie) {
        var t3 = null === h2 ? null : x(h2, 0.01, h2 - Math.abs(e3 - ie) / 100 / 4);
        J2({ touched: true, lastCY: ie, bg: 1 === n3 ? t3 : h2, minimal: 1 === n3 });
      } else J2({ touched: true, lastCY: e3, bg: ae, minimal: true });
    }(t2, r3);
  }
  function We(e2, n2) {
    var t2 = e2 - (null != re ? re : e2), r3 = n2 - (null != ie ? ie : n2), i3 = false;
    if (t2 < -40) Me(me + 1);
    else if (t2 > 40) Me(me - 1);
    else {
      var o3 = -(innerWidth + 20) * pe.current;
      Math.abs(r3) > 100 && le && w2 && (i3 = true, _e()), J2({ touched: false, x: o3, lastCX: void 0, lastCY: void 0, bg: h2, overlay: !!i3 || ue });
    }
  }
  E("keydown", function(e2) {
    if (O2) switch (e2.key) {
      case "ArrowLeft":
        Me(me - 1, true);
        break;
  ...
  return import_react.default.createElement(P, { className: "PhotoView-Portal" + (Te ? "" : " PhotoView-Slider__clean") + (O2 ? "" : " PhotoView-Slider__willClose") + (S2 ? " " + S2 : ""), role: "dialog", onClick: function(e2) {
    return e2.stopPropagation();
  }, container: j2 }, O2 && import_react.default.createElement(X, null), import_react.default.createElement("div", { className: "PhotoView-Slider__Backdrop" + (T2 ? " " + T2 : "") + (1 === Ee ? " PhotoView-Slider__fadeIn" : 2 === Ee ? " PhotoView-Slider__fadeOut" : ""), style: { background: Ve ? "rgba(0, 0, 0, " + Ve + ")" : void 0, transitionTimingFunction: Ie, transitionDuration: (ne ? 0 : Ae) + "ms", animationDuration: Ae + "ms" }, onAnimationEnd: ke }), k2 && import_react.default.createElement("div", { className: "PhotoView-Slider__BannerWrap" }, import_react.default.createElement("div", { className: "PhotoView-Slider__Counter" }, me + 1, " / ", we), import_react.default.createElement("div", { className: "PhotoView-Slider__BannerRight" }, W2 && Re && W2(Re), import_react.default.createElement(_, { className: "PhotoView-Slider__toolbarIcon", onClick: _e }))), Se.map(function(n2, t2) {
    var r3 = xe || 0 !== me ? pe.current - 1 + t2 : me + t2;
    return import_react.default.createElement(q, { key: xe ? n2.key + "/" + n2.src + "/" + r3 : n2.key, item: n2, speed: Ae, easing: Ie, visible: O2, onReachMove: Ne, onReachUp: We, onPhotoTap: function() {
      return Ye(s2);
    }, onMaskTap: function() {
      return Ye(v2);
    }, wrapClassName: R2, className: V2, style: { left: (innerWidth + 20) * r3 + "px", transform: "translate3d(" + ee + "px, 0px, 0)", transition: ne || te ? void 0 : "transform " + He + "ms " + Le }, loadingElement: A2, brokenElement: I2, onPhotoResize: Xe, isActive: pe.current === r3, expose: J2 });
  }), !y && k2 && import_react.default.createElement(import_react.default.Fragment, null, (xe || 0 !== me) && import_react.default.createElement("div", { className: "PhotoView-Slider__ArrowLeft", onClick: function() {
    return Me(me - 1, true);
  } }, import_react.default.createElement(M, null)), (xe || me + 1 < we) && import_react.default.createElement("div", { className: "PhotoView-Slider__ArrowRight", onClick: function() {
    return Me(me + 1, true);
  } }, import_react.default.createElement(Y, null))), N2 && Re && import_react.default.createElement("div", { className: "PhotoView-Slider__Overlay" }, N2(Re)));
}
var G = ["children", "onIndexChange", "onVisibleChange"];
var J = { images: [], visible: false, index: 0 };
function Q(t2) {
  var r2 = t2.children, i2 = t2.onIndexChange, o2 = t2.onVisibleChange, c2 = m(t2, G), u2 = p(J), l2 = u2[0], s2 = u2[1], d2 = (0, import_react.useRef)(0), v2 = l2.images, f2 = l2.visible, y2 = l2.index, x2 = g({ nextId: function() {
    return d2.current += 1;
  }, update: function(e2) {
  ...
  return import_react.default.createElement(w.Provider, { value: b2 }, r2, import_react.default.createElement(U, h({ images: v2, visible: f2, index: y2, onIndexChange: C2.changeIndex, onClose: C2.close }, c2)));
}
var Z = function(e2) {
